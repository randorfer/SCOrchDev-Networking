...
Describe -Tags 'VersionChecks' 'SCOrchDev-Networking manifest' {
    ...
    It 'has a valid name in the manifest' {
        $script:manifest.Name | Should Be SCOrchDev-Networking
    }

    It 'has a valid guid in the manifest' {
        $script:manifest.Guid | Should Be '9c721b17-09be-49ae-8259-444d140668a1'
    }
...
Describe 'Style rules' {
    $_ModuleBase = (Get-Module SCOrchDev-Networking).ModuleBase
